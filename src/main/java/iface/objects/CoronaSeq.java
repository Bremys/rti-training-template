...
/**
* A sequence of Corona instances.
*/
public final class CoronaSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public CoronaSeq (int initialMaximum) {
        super(Corona.class, initialMaximum);
    }

    public CoronaSeq (Collection elements) {
        super(Corona.class, elements);
    }

    public  Corona get(int index) { 
        return (Corona) super.get(index); 
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' Corona objects (beyond the original size of this object)
