...
public class CoronaTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "Corona";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CoronaTypeSupport _singleton
    = new CoronaTypeSupport();
    ...
    */
    public static CoronaTypeSupport get_instance() {
        return _singleton;
    }

    public static CoronaTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CoronaTypeCode.VALUE;
    }

    public Object create_data() {
        return Corona.create();
    }
    ...
    * <code>this</code> is not a <code>Corona</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Corona typedDst = (Corona) destination;
        Corona typedSrc = (Corona) source;
    ...
    int mask) {
        return new CoronaDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new CoronaDataReader(native_reader, listener, mask, this);   
    ...
    protected CoronaTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,CoronaTypeCode.VALUE,Corona.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected CoronaTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,CoronaTypeCode.VALUE,Corona.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
