...
/**
* A sequence of Plot instances.
*/
public final class PlotSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public PlotSeq (int initialMaximum) {
        super(Plot.class, initialMaximum);
    }

    public PlotSeq (Collection elements) {
        super(Plot.class, elements);
    }

    public  Plot get(int index) { 
        return (Plot) super.get(index); 
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' Plot objects (beyond the original size of this object)
