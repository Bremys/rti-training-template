...
public class AmitayTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "Amitay";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final AmitayTypeSupport _singleton
    = new AmitayTypeSupport();
    ...
    */
    public static AmitayTypeSupport get_instance() {
        return _singleton;
    }

    public static AmitayTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return AmitayTypeCode.VALUE;
    }

    public Object create_data() {
        return Amitay.create();
    }
    ...
    * <code>this</code> is not a <code>Amitay</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Amitay typedDst = (Amitay) destination;
        Amitay typedSrc = (Amitay) source;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.msg,255);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            Amitay typedDst = (Amitay) dst;
            typedDst.clear();      
            try{
                typedDst.msg = src.readString(255);
    ...
    int mask) {
        return new AmitayDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new AmitayDataReader(native_reader, listener, mask, this);   
    ...
    protected AmitayTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,AmitayTypeCode.VALUE,Amitay.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected AmitayTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,AmitayTypeCode.VALUE,Amitay.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
