...
/**
* A sequence of Amitay instances.
*/
public final class AmitaySeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public AmitaySeq (int initialMaximum) {
        super(Amitay.class, initialMaximum);
    }

    public AmitaySeq (Collection elements) {
        super(Amitay.class, elements);
    }

    public  Amitay get(int index) { 
        return (Amitay) super.get(index); 
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' Amitay objects (beyond the original size of this object)
